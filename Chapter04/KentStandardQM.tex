...
%	\draw[magenta,->,ultra thick] ({testxonep(\psione,\qttestx)},\a)--(\rrange,\a);
	...
	onwards so that the apparatus at time $t_m$  %
...
\nomenclature{ $[\psi]$}{The operator  $[\psi]$, \nomrefpage}%
...
\nomenclature{$\ket{\gamma_j'}$}{Corresponds to the $\ket{a_j}$-state of the apparatus $\mathcal{A}$ and which forms a component of one of the summands of $\ket{\Psi_S}$ as shown in equation (\ref{PsiSdecomp}), \nomrefpage}%
 that corresponds to the $\ket{a_j}$-state of the apparatus $\mathcal{A}$ and which forms a component of one of the summands of $\ket{\Psi_S}$ as shown in equation (\ref{PsiSdecomp}) will also appear $\ket{\Psi_{n,m}}$. It therefore follows that 
