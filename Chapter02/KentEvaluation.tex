...
\end{figure}
 ...
 \end{equation}
 and therefore from the definition of $\ev*{T^{\mu\nu}(y)}_{\tau_S}$ together with equation (\ref{conditionalexpectation}), we have 
...
\subsection{Kent's interpretation and Lorentz Invariance\label{LorentzInvariance}} 
