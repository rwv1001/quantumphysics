...
Kent implicitly assumes that a specification of the stress-energy tensor $T^{\mu\nu}(y)$ for all spacetime locations $y$ between $S_0$ and $S$ will be sufficient to give a macroscopic description of physical reality between $S_0$ and $S$.\footnote{See \cite[2]{Kent2014} where he talks about giving a description of reality between $S_0$ and $S$.} This seems like a reasonable assumption, since from the $T^{00}(y)$ component of the stress-energy tensor, we will be able to tell how much energy is present in the vicinity of $y$, and from the other components of the stress-energy tensor, we will be able to work out how much of this energy is due to mass and how much is due to motion.\footnote{Note that it doesn't matter that  $\hat{T}^{\mu\nu}(y)$ won't typically commute for all $\mu$ and $\nu$. This is because the value of $T^{\mu\nu}$ that Kent ascribes to the spacetime location $y$ is not the eigenvalue for some simultaneous eigenstate of the $\hat{T}^{\mu\nu}(y)$ for all $\mu$ and $\nu$ (non-communitativity of the $\hat{T}^{\mu\nu}(y)$ would guarantee that there is no such simultaneous eigenstate). Rather, the value of $T^{\mu\nu}$ that Kent ascribes to the spacetime location $y$ is an expectation value of  $\hat{T}^{\mu\nu}(y)$ conditioned on the mass-energy density $T_S(x)$ on $S$, and so the non-commutativity of the $\hat{T}^{\mu\nu}(y)$ is irrelevant when calculating this expectation value. One might still wonder whether it sensible to ascribe the the conditioned expectation value of  $\hat{T}^{\mu\nu}(y)$ to $T^{\mu\nu}$. But as we will see in section \ref{KentconsistentQT}, conditioning on the mass-energy density $T_S(x)$ on $S$ will allow us to obtain a conitioned quantum state, and we should be able to expect there to be sufficient information in the mass-energy density $T_S(x)$ on $S$ to ensure that the conditioned quantum state close enough to being an eigenstate of all the $\hat{T}^{\mu\nu}(y)$ to form a macroscopic picture of stess-energy tensor in the vicinity of $y$.}  Thus, from the stress-energy tensor, we will be able to form a picture of where things are and whether things are in equilibrium or whether there are flows of matter and energy from one region to another. Such a description of reality will also include information about measurement readings that scientists observe when performing their experiments, so although  we wouldn't expect there to be a complete specification of physical reality down to the microscopic level in terms of the stress-energy tensor, there will be enough information in the stress-energy tensor at the macroscopic level to make various scientific claims about physical reality at the microscopic level. 
