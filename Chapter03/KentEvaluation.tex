...
*****
We thus aim to show that the predictions of Kent's theory do not contradict the  predictions of quantum theory that have been experimentally validated. We also aim to show that Kent's theory possesses the symmetries (known as Lorentz invariance) that belong to a theory that is consistent with Einstein's theory of special relativity. And we will also consider Kent's theory in the light of decoherence theory and show how Kent succeeds in giving us a convincing account of what an outcome is. 
